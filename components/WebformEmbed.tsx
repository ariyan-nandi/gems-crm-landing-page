...
<div class="crm-webform-container" id="crm-container-cmpgvculi0006wgowsyxs8pb7">
<div class="crm-form-header">bhhhh</div>
<form id="crm-webform-cmpgvculi0006wgowsyxs8pb7" enctype="multipart/form-data">
<input type="hidden" name="webformId" value="cmpgvculi0006wgowsyxs8pb7" />
<input type="hidden" name="module" value="Tickets" />
<div class="crm-form-row">
<div class="crm-form-group" style="flex: 1 1 100%; max-width: 100%; min-width: 0;">
<label for="crm_subject_cmpgvculi0006wgowsyxs8pb7" class="crm-form-label">Subject <span style="color:#dc3545; margin-left:3px;">*</span></label>
<input id="crm_subject_cmpgvculi0006wgowsyxs8pb7" type="text" name="subject" required  class="crm-form-input" placeholder="" style="width: 100%; height: auto; " />
</div>
<div class="crm-form-group" style="flex: 1 1 100%; max-width: 100%; min-width: 0;">
<label for="crm_email_cmpgvculi0006wgowsyxs8pb7" class="crm-form-label">Email <span style="color:#dc3545; margin-left:3px;">*</span></label>
<input id="crm_email_cmpgvculi0006wgowsyxs8pb7" type="email" name="email" required  class="crm-form-input" placeholder="" style="width: 100%; height: auto; " />
</div></div>
<div class="crm-form-footer"><button type="submit" class="crm-form-submit">Submit</button></div>
</form>
<div id="crm-form-message-cmpgvculi0006wgowsyxs8pb7" class="crm-message-box"></div>
</div>
</div>
 
<script>
document.getElementById('crm-webform-cmpgvculi0006wgowsyxs8pb7').addEventListener('submit', function(e) {
    e.preventDefault();
    var form = e.target;
    ...
    fetch('http://localhost:4008/cm/api/webform-submissions', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({webformId: 'cmpgvculi0006wgowsyxs8pb7', fields: data})
