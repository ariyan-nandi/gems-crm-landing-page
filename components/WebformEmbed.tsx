...
<div class="crm-webform-container" id="crm-container-cmqahmwzk0002o21d0zw3xe8n">
<div class="crm-form-header">Leads capture from website</div>
<form id="crm-webform-cmqahmwzk0002o21d0zw3xe8n" enctype="multipart/form-data">
<input type="hidden" name="webformId" value="cmqahmwzk0002o21d0zw3xe8n" />
<input type="hidden" name="module" value="Leads" />
<div class="crm-form-row">
<div class="crm-form-group" style="flex: 1 1 calc(48% - 15px); max-width: calc(48% - 15px); min-width: 0;">
<label for="crm_firstName_cmqahmwzk0002o21d0zw3xe8n" class="crm-form-label">First Name <span style="color:#dc3545; margin-left:3px;">*</span></label>
<input id="crm_firstName_cmqahmwzk0002o21d0zw3xe8n" type="text" name="firstName" required  class="crm-form-input" placeholder="" style="width: 100%; height: auto; " />
</div>
<div class="crm-form-group" style="flex: 1 1 calc(48% - 15px); max-width: calc(48% - 15px); min-width: 0;">
<label for="crm_lastName_cmqahmwzk0002o21d0zw3xe8n" class="crm-form-label">Last Name <span style="color:#dc3545; margin-left:3px;">*</span></label>
<input id="crm_lastName_cmqahmwzk0002o21d0zw3xe8n" type="text" name="lastName" required  class="crm-form-input" placeholder="" style="width: 100%; height: auto; " />
</div>
<div class="crm-form-group" style="flex: 1 1 100%; max-width: 100%; min-width: 0;">
<label for="crm_email_cmqahmwzk0002o21d0zw3xe8n" class="crm-form-label">Email ID <span style="color:#dc3545; margin-left:3px;">*</span></label>
<input id="crm_email_cmqahmwzk0002o21d0zw3xe8n" type="email" name="email" required  class="crm-form-input" placeholder="" style="width: 100%; height: auto; " />
</div>
<div class="crm-form-group" style="flex: 1 1 100%; max-width: 100%; min-width: 0;">
<label for="crm_company_cmqahmwzk0002o21d0zw3xe8n" class="crm-form-label">Company <span style="color:#dc3545; margin-left:3px;">*</span></label>
<input id="crm_company_cmqahmwzk0002o21d0zw3xe8n" type="text" name="company" required  class="crm-form-input" placeholder="" style="width: 100%; height: auto; " />
</div>
<div class="crm-form-group" style="flex: 1 1 100%; max-width: 100%; min-width: 0;">
<label for="crm_phoneNumber_cmqahmwzk0002o21d0zw3xe8n" class="crm-form-label">Phone No. </label>
<input id="crm_phoneNumber_cmqahmwzk0002o21d0zw3xe8n" type="tel" name="phoneNumber"   class="crm-form-input" placeholder="" style="width: 100%; height: auto; " />
</div>
<div class="crm-form-group" style="flex: 1 1 100%; max-width: 100%; min-width: 0;">
<label for="crm_country_cmqahmwzk0002o21d0zw3xe8n" class="crm-form-label">Country </label>
<select id="crm_country_cmqahmwzk0002o21d0zw3xe8n" name="country"  class="crm-form-input" style="width: 100%; height: auto; "><option value="">Select...</option></select>
</div></div>
<div class="crm-form-footer"><button type="submit" class="crm-form-submit">Submit</button></div>
</form>
<div id="crm-form-message-cmqahmwzk0002o21d0zw3xe8n" class="crm-message-box"></div>
</div>
</div>
 
<script>

document.getElementById('crm-webform-cmqahmwzk0002o21d0zw3xe8n').addEventListener('submit', function(e) {
    ...
    var msgDiv = document.getElementById('crm-form-message-cmqahmwzk0002o21d0zw3xe8n');
    ...
    fetch('/cm/api/webform-submissions', {
        ...
        body: JSON.stringify({webformId: 'cmqahmwzk0002o21d0zw3xe8n', fields: data})
